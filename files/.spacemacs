...
(defun dotspacemacs/layers ()
  ...
  (setq-default
   ...
   dotspacemacs-configuration-layers '(;emmet
                                       auto-completion
                                       git
                                       html
                                       syntax-checking
   ...
   dotspacemacs-additional-packages '(bracketed-paste evil-terminal-cursor-changer)
...
before layers configuration."
  ...
  (setq-default
   ...
   dotspacsmacs-verbose-loading nil
...
(defun dotspacemacs/config ()
  "Configuration function. etq evil-insert-stathis function is called at the very end of Spacemacs initialization"
  ; Editing
